...
const AuthPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, we would submit this data to an API for authentication
      ...
      {mode === "signup" && (
        <div className="flex-1 flex flex-col justify-center px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-3 bg-white text-zoo-primary rounded-lg font-medium">
              SIGN UP
            </button>
          </form>
          ...
          <div className="mt-6 text-center text-white">
            ...
            <button className="w-full py-3 bg-white rounded-lg font-medium flex items-center justify-center">
      ...
      {mode === "signin" && (
        <div className="flex-1 flex flex-col justify-center px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-3 bg-white text-zoo-primary rounded-lg font-medium mt-4">
              SIGN IN
            </button>
          </form>
